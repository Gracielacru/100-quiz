...
// 2. Declare a variable named 'stringVar' of type let and assign it a value of 'Hello'.let stringVar = " Hello";
let stringVar = " Hello";
...
// 18. Check if 'stringVar' is not equal to 'Hello World'. // should print true
...
console.log("[Question #31]: ", (isEven = 10 % 2 === 0)); // should print true

// 32. Create a variable 'result' and assign it the result of 10 raised to the power of 3.
console.log("[Question #32]: ", (result = 10 ** 3)); // should print 1000
...
console.log("[Question #43]: ", includesBanana); // should print warm
...
console.log("[Question #47]: ", (squared = numberVar ** 2)); // should print 25
...
console.log("[Question #70]: ", typeof city === "string"); // should print true
...
const cubeVolumen = Math.pow(radius, 3);
console.log("[Question #86]; ", cubeVolumen);
...
console.log("[Question #98]: ", book.isbn !== undefined);
